  ...
  const handlesubmit = async (e) => {
    ...
    try {
      var res = await axios.post(
        "https://placement-fsd.onrender.com/user",
        data
      );
      if (res.status === 200) {
  ...
  return (
    <>
      <div className="bg-white p-14 ">
        <form>
          <div>
            <label for="firstName" className="text-red-600 text-xl">
              FirstName
            </label>
            <input
              type="text"
          ...
          <div>
            <label for="lastName" className="text-red-600 text-xl">
              LastName
            </label>
            <input
              type="text"
          ...
          <a href="/" className="p-1 border-4 mb-16 mt-7 text-white bg-black">
            LOGIN
          </a>
        </form>
      </div>
